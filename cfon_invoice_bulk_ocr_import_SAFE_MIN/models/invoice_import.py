...
def parse_invoice_text(txt):
    """
    Simple heuristic parser for ES/EN invoices.
    """
    data = {}
...
cfon_dropzone_enable_vendor_bills = fields.Boolean(
    string='Dropzone en Facturas de Proveedor',
    config_parameter='cfon_invoice_bulk.dropzone_vendor_bills',
    default=True,
    help='Muestra el área de arrastrar y soltar en Facturas de Proveedor.'
)
cfon_dropzone_enable_customer_invoices = fields.Boolean(
    string='Dropzone en Facturas de Cliente',
    config_parameter='cfon_invoice_bulk.dropzone_customer_invoices',
    default=False,
    help='Permite arrastrar y soltar también en facturas de cliente (creará in_invoice igualmente).'
)
cfon_dropzone_enable_documents = fields.Boolean(
    string='Dropzone en módulo Documentos',
    config_parameter='cfon_invoice_bulk.dropzone_documents',
    default=True,
    help='Muestra el dropzone cuando estés en Documentos para soltar facturas.'
)
