...
class StockPicking(models.Model):
    ...
    def button_validate(self, force_validate=False):
        res = super(StockPicking, self).button_validate(force_validate)
        ...
        for picking in self:
            ...
            if purchase and purchase.x_studio_comprado:
                ...
                if template and wa_account:
                    # Crear mensaje de WhatsApp sin message_type ni state
