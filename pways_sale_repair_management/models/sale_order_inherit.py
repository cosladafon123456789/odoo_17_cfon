...
class SaleOrder(models.Model):
	...
	def button_refund(self):
		...
		repair_lines = self.order_line.filtered(lambda l: l.create_repair_order)
		if not repair_lines:
			raise ValidationError("No lines are selected to create Refund.")
	...
	def button_return_to_customer(self):
		...
		repair_lines = self.order_line.filtered(lambda l: l.create_repair_order)
		if not repair_lines:
			raise ValidationError("No lines are selected to create Return order to Customer.")
	...
	def button_rma(self):
		...
		repair_lines = self.order_line.filtered(lambda l: l.create_repair_order)
		if not repair_lines:
			raise ValidationError("No lines are selected to create RMA.")
