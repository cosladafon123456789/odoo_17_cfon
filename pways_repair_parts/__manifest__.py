{
	...
	'version': '17.0',
	'category': 'Sales',
	"summary": """ june-17-2025  Auto-purchase missing repair parts and start RMA from serial numbers.""",
	...
	'depends': ['sale_stock', 'purchase_stock', 'pways_sale_repair_management','product_expiry'],
	'data': [
